# Oasis Emerald Token Creation Tool

A simple frontend tool to create tokens on the Oasis Emerald (ROSE) network using a backend API.
...
- Insert this project link https://github.com/BayHatter/Oasis-Emerald-Token-Creation-Tool-Without-Coding.git
- And press deploy
- Congrats your Oasis Emerald Token Creation Tool installed on your vercel.com account
...
- Then donwload our code from https://github.com/BayHatter/Oasis-Emerald-Token-Creation-Tool-Without-Coding
- Upload into your Github repo.
- Edit the file public/config.json and insert your Oasis Emerald wallet address for receiving fees. Also set fee in ROSE that you want to charge
